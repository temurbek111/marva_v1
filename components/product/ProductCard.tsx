    ...
    >
      ...
      <div className="px-4 pb-4">
        <div className="flex items-start justify-between gap-2">
          <p className="line-clamp-1 text-xs text-[#6E8782]">
            {product.shortDescription || "Dental mahsulot"}
          </p>
        ...
        <h3 className="mt-2 min-h-[48px] line-clamp-2 text-[16px] font-semibold leading-6 text-[#12332D]">
          {product.name}
        </h3>
        ...
        <div className="mt-4 flex items-end justify-between gap-3">
          ...
          {!mounted ? (
            <button
              ...
              className="flex h-10 w-10 items-center justify-center rounded-full bg-[#004F45] text-white shadow-[0_10px_22px_rgba(0,79,69,0.18)]"
